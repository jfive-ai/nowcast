...
/// Right-hand "show your work" drawer. For each cluster of the
...
struct ProvenanceView: View {
    ...
    private var emptyState: some View {
        VStack(spacing: 6) {
            ...
            Text("This report doesn't carry the per-claim citation block — usually only briefs generated by an older version of the app.")
